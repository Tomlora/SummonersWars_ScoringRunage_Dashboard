...
def find_monsters():
    ...
    if element_selected != '*':
        data_monsters = data_monsters[data_monsters['element'] == element_selected]
    
    if lead_selected != '*':
        data_monsters = data_monsters[data_monsters['area_leader'] == lead_selected]
    ...
    column_monsters = ['name', 'element', 'archetype', 'attribute_leader', 'amount_leader', 'area_leader', 'element_leader']
    if buff_selected == '-1':
        ...
        st.dataframe(data_monsters[data_monsters['id'].isin(list_mob)][column_monsters])